# V3-VerifyPackage.ps1 (package v10) - binds the CI run to the EXACT reviewed package bytes. Runs
...
param(
  ...
  [string]$RepoRoot = '.',
  [string]$ZipPath = 'package\V3-PRODUCTION-SIGNING-PACKAGE-v10.zip',
...
try {
  ...
  Write-Host '== V3 PACKAGE BINDING VERIFICATION (v10, canonical committed-blob comparison) =='
  ...
  $expected = @(
    'OWNER_PRODUCTION_SIGNING_RUNBOOK_WINDOWS-v10.md',
