...
2. The exact UKI init requires two block devices already present as `/dev/v3-rootfs-data` and `/dev/v3-rootfs-hash`; it then constructs the exact read-only dm-verity table with root `533d6d61d83ad8e03539549d500fb74ec6d844f18ee3bcaec238f7fb78303245`.
...
| genuine block devices | SECURITY-AUTHORITATIVE | Two block devices at exact paths `/dev/v3-rootfs-data` and `/dev/v3-rootfs-hash`; data image `77a3bd99ad9dbfa18952dcc7b2bd180bbebd57843ac8c21edcec63dc737b64f0`; verity tree `331502b7de57f7899fa1af25158c398e9603ee2644a9d1e165ebc955d59118e4`. | Guest `stat` must prove block-device type; bytes/digests must match; swap, alias or ordinary-file substitution must fail. |
