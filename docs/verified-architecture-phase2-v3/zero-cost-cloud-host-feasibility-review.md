...
2. The exact UKI init requires two block devices already present as `/dev/v3-rootfs-data` and `/dev/v3-rootfs-hash`; it then constructs the exact read-only dm-verity table with root `b78ccbc789be451715c52d661902d61abc3e149ea0e26afb2491f6a467c47646`.
...
| genuine block devices | SECURITY-AUTHORITATIVE | Two block devices at exact paths `/dev/v3-rootfs-data` and `/dev/v3-rootfs-hash`; data image `5c6b747d4b2ffa44655f3f2139e3993e2740534e0fc6c8ae67916c13238ba148`; verity tree `10552718d890533e447ef611c82de67cbc2af7c2258f44f7c2c0aaef661e8285`. | Guest `stat` must prove block-device type; bytes/digests must match; swap, alias or ordinary-file substitution must fail. |
