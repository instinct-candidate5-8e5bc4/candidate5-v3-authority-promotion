...
2. The exact UKI init requires two block devices already present as `/dev/v3-rootfs-data` and `/dev/v3-rootfs-hash`; it then constructs the exact read-only dm-verity table with root `e6ddb15916e12220c6117b6abded6550acd77df9379101662d8af78c7396dad7`.
...
| genuine block devices | SECURITY-AUTHORITATIVE | Two block devices at exact paths `/dev/v3-rootfs-data` and `/dev/v3-rootfs-hash`; data image `b345d4eccd3232e707cda9ff283d813a7ac9c6d2c6ff53a2e7190cf0de172689`; verity tree `65dad47fdaad4a0e2231e7638f866a6b5d67b2a8a4bf5daee4621e17e2b33fff`. | Guest `stat` must prove block-device type; bytes/digests must match; swap, alias or ordinary-file substitution must fail. |
