...
2. The exact UKI init requires two block devices already present as `/dev/v3-rootfs-data` and `/dev/v3-rootfs-hash`; it then constructs the exact read-only dm-verity table with root `b1d724bb9ffdb3ecd6a0db36590090e4362b5f0aff6959eff868e83079efa7cf`.
...
| genuine block devices | SECURITY-AUTHORITATIVE | Two block devices at exact paths `/dev/v3-rootfs-data` and `/dev/v3-rootfs-hash`; data image `b541bfef551fa845dddcb4f0d342e2f9dd2c6706b618da04bc5597125783a9a5`; verity tree `3eedbe43a7ba60e70f7bf9bbf81f75c02ce6e3d990aff04e797915b3bcee0a07`. | Guest `stat` must prove block-device type; bytes/digests must match; swap, alias or ordinary-file substitution must fail. |
