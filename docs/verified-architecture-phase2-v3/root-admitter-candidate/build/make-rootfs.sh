...
truncate -s 100663296 "$out"
/usr/sbin/mke2fs -q -t ext4 -b 4096 -I 256 -U 00000000-0000-0000-0000-000000000001 -E hash_seed=00000000-0000-0000-0000-000000000002,lazy_itable_init=0,lazy_journal_init=0 -O ^has_journal,^metadata_csum_seed -d "$root" "$out" 24576
