...
add('incorrect-handoff','E_OLD_INIT_EXEC',emit('incorrect-handoff',base_init.replace('exec /init.root-admitter || fail E_OLD_INIT_EXEC','/no-such-init || fail E_OLD_INIT_EXEC')))
