...
bind_names=['README.md','build-successor.py','builder-runtime.v1.json','cloud-boot-adapter.sh','verify-candidate.py','inventory.v1.json','successor-initramfs.cpio','successor-unsigned.efi']
binding={'schema':'v3.successor-uki-external-binding.v1','status':'RUNTIME_EVIDENCE_REQUIRED','domain':'V3-SUCCESSOR-UKI-EXTERNAL-BINDING:v1','records':[]}
for n in bind_names:
 src=(HERE/n) if n in ('README.md','build-successor.py','builder-runtime.v1.json','cloud-boot-adapter.sh','verify-candidate.py') else (OUT/n)
